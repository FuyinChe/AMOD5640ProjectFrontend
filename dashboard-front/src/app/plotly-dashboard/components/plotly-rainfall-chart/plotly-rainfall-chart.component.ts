...
export class PlotlyRainfallChartComponent implements OnChanges {
  ...
  private loadRainfallData(): void {
    this.rainfallService.getHourlyRainfallData(this.startDate, this.endDate, 'day').subscribe({
      next: (response: any) => {
  ...
  private processRainfallData(response: any): void {
    ...
    this.chartLayout.title.text = `Rainfall Analysis (${this.startDate} to ${this.endDate})`;
